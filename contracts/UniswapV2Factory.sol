...
contract UniswapV2Factory is IUniswapV2Factory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        // NOTE: create2 addr <- keccak256(creation bytecode) <- constructor args (改变会导致addr变化)
        // 计算合约地址方式： create2 addr = keccak256(0xff, deployer, salt, keccak256(creation bytecode))
